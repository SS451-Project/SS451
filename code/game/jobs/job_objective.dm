...
/datum/game_mode/proc/declare_job_completion()
	var/text = "<hr><b><u>Завершение Работы</u></b>"
	...
	for(var/datum/mind/employee in SSticker.minds)
		...
		if(tasks_completed >= 1)
			text += "<br>&nbsp;<font color='green'><B>[employee.name] как [employee.p_their()] сделал свою ебучую работу!</B></font>"
