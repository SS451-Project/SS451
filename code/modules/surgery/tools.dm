...
/obj/item/scalpel/laser/laser1 //lasers also count as catuarys
	name = "лазерный скальпель"
	desc = "Скальпель, дополненный направленным лазером. Это выглядит довольно простым и может быть улучшено."
	icon_state = "scalpel_laser1_on"
	toolspeed = 0.8

/obj/item/scalpel/laser/laser2
	name = "лазерный скальпель"
	desc = "Скальпель, дополненный направленным лазером. Выглядит несколько продвинутым."
	icon_state = "scalpel_laser2_on"
	toolspeed = 0.6

/obj/item/scalpel/laser/laser3
	name = "лазерный скальпель"
	desc = "Скальпель, дополненный направленным лазером. Похоже это вершина прецизионных энергетических столовых приборов!"
	icon_state = "scalpel_laser3_on"
	toolspeed = 0.4

/obj/item/scalpel/laser/manager //super tool! Retractor/hemostat
	name = "система управления разрезами"
	desc = "Истинное продолжение тела. Это чудо мгновенно и полностью подготавливает разрез, позволяющий немедленно приступить к терапевтическим этапам."
